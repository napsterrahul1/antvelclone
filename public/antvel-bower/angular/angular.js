   ...
   <example module="currencyExample">
     <file name="index.html">
       ...
       <div ng-controller="ExampleController">
         ...
         custom currency identifier (INR$): <span id="currency-custom">{{amount | currency:"INR$"}}</span>
         no fractions (0): <span id="currency-no-fractions">{{amount | currency:"INR$":0}}</span>
       </div>
     </file>
     <file name="protractor.js" type="protractor">
       it('should init with 1234.56', function() {
         expect(element(by.id('currency-default')).getText()).toBe('$1,234.56');
         expect(element(by.id('currency-custom')).getText()).toBe('INR$1,234.56');
         expect(element(by.id('currency-no-fractions')).getText()).toBe('INR$1,235');
       });
       it('should update', function() {
         ...
         expect(element(by.id('currency-custom')).getText()).toBe('(INR$1,234.00)');
         expect(element(by.id('currency-no-fractions')).getText()).toBe('(INR$1,234)');
       });
     </file>
   </example>
 */
