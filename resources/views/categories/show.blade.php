    ...
    <div ng-controller="CategoryController" class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="row form-group">
                ...
                <div class="col-md-2">
                    <div class="thumbnail" style="height:120px; background-image:url('{!! url( $category->image ? $category->image :  'img/no-image.jpg') !!}'); background-size: 100%;" ></div>
                </div>
            </div>
            <div class="row form-group">
            ...
            <div class="row form-group">
                <div class="col-md-6">
                    <a href="{!! url('wpanel/category/'.$category->id.'/edit/') !!}" class="btn btn-default">Edit</a>
                </div>
            </div>
        </div>
    </div>
