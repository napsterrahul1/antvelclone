...
@section('center_content')
	...
	<div ng-controller="CategoryController" class="panel panel-default">
		...
		<div class="panel-body" ng-init="icon='{{ $category->icon }}'">
			{!! Form::model($category,['url'=>['wpanel/category/update/'.$category->id],'method'=>'PUT','class'=>'form-horizontal','role'=>'form']) !!}
				...
				<div class="row form-group">
					...
					<div class="col-md-2">
						...
						<div class="thumbnail" ng-file-select ng-model="image_upload" accept=".jpg,.png" style="height:120px; background-image:url('{!! url('img/no-image.jpg') !!}'); background-size: 100%;"></div>
	...
	<script>
		(function(app){
            app.controller('CategoryController', ['$scope', '$upload','$timeout','notify',
                ...
                $scope.link=function(){
                    return '{{ url('wpanel/category/ID/edit') }}'.replace('ID',$scope.category.id);
                };
                $scope.type=function(){
