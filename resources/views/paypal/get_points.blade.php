        ...
        <div class="panel-body cart-resume">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-4 col-md-3 col-lg-3" >
                    <img ng-src="{!! url('img/paypal_points.jpg') !!}" alt="[[ product.name ]]" style="width: 100%; heigth: 200px;" >
                </div>
                <div class="col-xs-12 col-sm-4 col-md-5 col-lg-5">
                    <div class="text-small hidden-xs"><strong><h6>{{ trans('store.paypal.antvel_points_bundle') }}</h6></strong></div>
                    <div class="text-small"><strong>{{ trans('product.globals.price') }}: </strong>100 Rs</div>
