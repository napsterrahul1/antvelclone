									...
									<div class="col-lg-12">
										<div class="pull-left" ng-controller="uploadCtrl">
											...
											<div class="user-photo">
												<img src="{!! \App\Helpers\Utility::getStoragePath() . '[[picture]]' !!}" class="thumbnail" style="width:80px;"  alt="Photo" ng-file-select ng-model="files" ngf-accept="'image/*'" accept="image/*">
