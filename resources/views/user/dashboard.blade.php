		...
		<div class="page-header">
	  	...
	  	@if (\Auth::check() && \Auth::user()->hasRole(['business','admin']))
			...
			<div class="list-group">
				@if(\Auth::user()->hasRole(['subadmin','admin']))
				<a href="javascript:void(0);" class="list-group-item active">{{ trans('user.all_products') }}</a>
				@else
			...
			<div class="list-group">
				@if(\Auth::user()->hasRole(['subadmin','admin']))
				<a href="javascript:void(0);" class="list-group-item active">{{ trans('user.all_sales') }}</a>
				@else
