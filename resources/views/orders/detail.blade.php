            ...
            <div class="col-md-12">
                <ol class="breadcrumb">
                    ...
                    <li>
                        ...
                        <a href="javascript:void(0);" ng-controller="ModalCtrl" ng-click="modalOpen({templateUrl:'{!! url('user/orders/comment/'.$order->id) !!}',controller:'CommentControllerModal',resolve:'comment'})">
                    ...
                    @if(isset($is_buyer))
                        ...
                        @if ($order->status == 'closed' && !($order->rate))
                            <li>
                                ...
                                <a href="javascript:void(0);" ng-controller="ModalCtrl" ng-click="modalOpen({templateUrl:'{!! url('user/orders/rate/'.$order->id) !!}',controller:'RateOrdersControllerModal',resolve:'order'})">
                        ...
                        <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-4 col-xs-8 text-center">
                                    <img  class="img-rounded" src='{{ \App\Helpers\Utility::getStoragePath() . $detail->product->features['images'][0] }}' alt="{{ $detail->product->name }}" width="100%" height="90">
                                </div>
