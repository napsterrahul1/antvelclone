<div class="modal-content rate_order">
    <div class="modal-header">
        ...
        <h6 class="modal-title">
            ...
            &nbsp;-&nbsp;
            {{ trans('store.order_rate_view.sold_by') }}:&nbsp;
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 clearfix">
                                <div class="media">
                                    <div class="media-left">
                                        <a href="#">
                                            <img class="media-object img-rounded" style ="width: 50px; height: 50px;" ng-src="{{ \App\Helpers\Utility::getStoragePath() . $detail->product->features['images'][0] }}" alt="{{ $detail->product->name }}">
                                        </a>
                                    </div>
                                    <div class="media-body">
                                        ...
                                        @if (trim($detail->rate) == '')
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <label>{{ trans('store.order_rate_view.rate_this_seller') }}:</label>&nbsp;
                                                    <rating max="5" state-on="'fa fa-star'" state-off="'fa fa-star-o'" id="rate_{{ $detail->product_id }}" readonly="false" ng-model="ratingOrdItems.rate_{{ $detail->product_id }}"></rating>
                                                    <textarea
                                                        rows = "1"
