                                ...
                                @if(isset($isResume))
                                    <form action="https://test.payu.in/_payment" method="post" name="payuForm">
                                        ...
                                        <button class="btn btn-info" type="submit">
                                            ...
                                            {{ trans('store.placeYourOrder') }} online
                                        </button>
                                    </form><br>
                ...
                @foreach ($cart['details'] as $item)
                    ...
                    <div class="text-small col-lg-6">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                            <a ng-controller="ModalCtrl" ng-init='data={"data":"{{ $item['product']['id'] }}"}' ng-click="modalOpen({templateUrl: base_url+'modalDetailsProductCart',controller:'getDetailsProductInCart',resolve:'data'})">
                                <img class="thumbnail" src='{{ \App\Helpers\Utility::getStoragePath() . $item["product"]["features"]["images"][0] }}' alt="{{ $item['product']['name'] }}" height="150" width="150">
                            </a>
                        </div>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-small">
                            ...
                            @if(isset($user))
                                ...
                                | <a ng-controller="ModalCtrl" href="javascript:void(0)" ng-init='data={"data":"{{ $item['product']['id'] }}"}' ng-click="modalOpen({templateUrl: base_url+'modalDetailsProductCart',controller:'getDetailsProductInCart',resolve:'data'})">{{ trans('product.globals.view_details') }}</a>
                            @endif
                        </div>
