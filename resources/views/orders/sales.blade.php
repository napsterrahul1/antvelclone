        ...
        <div ng-controller="Orders">
            ...
            <div class="tabbable">
                <ul class="nav nav-tabs hidden-xs">
                    <li class="{{ $select == 'open' || $select == '' ? 'active' : '' }}"><a href="#pane1" data-toggle="tab">{{ trans('store.openOrders') }}&nbsp;<span class="badge colorred">{{ count($openOrders) }}</span></a></li>
                     <li class="{{ $select == 'rate' ? 'active' : '' }}"><a href="#pane4" data-toggle="tab">{{ trans('store.unrated_orders') }}&nbsp;<span class="badge colorred">{{ count($unRate) }}</span></a></li>
                    <li class="{{ $select == 'closed' ? 'active' : '' }}"><a href="#pane2" data-toggle="tab">{{ trans('store.closedOrders') }} <span class="badge colorred"> {{ count($closedOrders) }}</span></a></li>
                    <li class="{{ $select == 'canceled' ? 'active' : '' }}"><a href="#pane3" data-toggle="tab">{{ trans('store.canceledOrders') }} <span class="badge colorred">{{ count($cancelledOrders) }}</span></a></li>
                </ul>
                <div class="visible-xs-block">
                    <a href="#pane1" data-toggle="tab">{{ trans('store.open') }}&nbsp;<span class="badge colorred">{{ count($openOrders) }}</span></a> -
                    <a href="#pane4" data-toggle="tab">{{ trans('store.unrated') }}&nbsp;<span class="badge colorred">{{ count($unRate) }}</span></a> -
                    <a href="#pane2" data-toggle="tab">{{ trans('store.closed') }} <span class="badge colorred"> {{ count($closedOrders) }}</span></a> -
                    <a href="#pane3" data-toggle="tab">{{ trans('store.cancelled') }} <span class="badge colorred">{{ count($cancelledOrders) }}</span></a>
                </div>
