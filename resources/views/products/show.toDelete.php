...
@section('metaLabels')
    ...
    @include('partial.social_tags', [
        'title' => $product->name,
        'image' => isset($product->features['images'][0]) ? URL::to('/').$product->features['images'][0] : '{!! url('img/no-image.jpg') !!}',
            ...
            <div class="row">
                ...
                <div>
                    ...
                    <div class="col-xs-12 col-sm-4 thumbnail" >
                        ...
                        @else
                            <img  src="{!! url('img/no-image.jpg') !!}" alt="{{$product->name}}"  >
                        @endif
                    </div>
                    @endif
                    ...
                    <div class="col-xs-12 col-sm-{{(Auth::id()===$product->user_id?12:3)}} well">
                        @if ($product->type!='freeproduct')
                            ...
                            @elseif($product->status!=0)
                                ...
                                @else
                                    <a  href="/" class="btn btn-info ">{{ trans('store.addToWishList') }}</a>
                                @endif
                                </div>
