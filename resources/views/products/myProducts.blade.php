                        ...
                        <div style="height: 18em;">
                            ...
                            <a href="{{ action('ProductsController@index') }}/{{ $product->id }}">
                                @if (isset($product->features['images'][0]))
                                    <img class="thumbnail"
                                         src="{{ \App\Helpers\Utility::getStoragePath() . $product->features['images'][0] }}?w=100" alt="{{ $product->name }}"
                                         width="100" height="100">
                                @else
                                    <img class="thumbnail" src="{!! url('img/no-image.jpg') !!}" alt="{{ $product->name }}" width="100" height="100">
                                @endif
                            ...
                            @endif
                                <br>
                            <small>{{ $product->view_counts.' '.trans('product.globals.views') }} </small>
                                <br>
