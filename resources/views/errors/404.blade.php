...
@section('content')
	...
	<p class="lead">
		...
		<a href="javascript.void(0)" onclick="window.history.back();" style="background-color: yellow;">{{ trans('globals.404_error.link_01') }}</a>
		
		{{ trans('globals.404_error.message_02') }} <a href="{!! url('/') !!}" style="background-color: yellow;">{{ trans('globals.404_error.link_02') }}</a>
	</p>
