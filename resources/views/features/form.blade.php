...
@section('center_content')
	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
			@if(!$edit)
			{!! Form::model(Request::all(),['url'=>'wpanel/productsdetails/store', 'class'=>'form-horizontal', 'role'=>'form','ng-controller'=>'features_form']) !!}
			@else
			{!! Form::model($feature,['url'=>['wpanel/productsdetails/update/'.$feature['id']], 'class'=>'form-horizontal', 'role'=>'form','method'=>'PUT','ng-controller'=>'features_form']) !!}
			@endif
