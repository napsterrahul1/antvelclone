    ...
    <div class="row">
        ...
        <div class="panel panel-default">
            <div class="panel-heading" ng-init="search=''">
                ...
                <a href="{{ url('wpanel/productsdetails/create') }}" class="btn btn-default btn-md pull-right">{{ trans('features.new_feature') }}</a>
                </h6>
            </div>
                ...
                <ul class="list-group">
                    ...
                    <li class="list-group-item">
                        <div class="row">
                            ...
                            <div class="col-md-4"><a href="{{ url('wpanel/productsdetails/show/'.$row['id']) }}">{{ $row['name'] }}</a></div>
                            <div class="col-md-2">{{ $row['status'] }}</div>
                            <div class="col-md-2">{{ $row['input_type'] }}</div>
                            <div class="col-md-2">{{ $row['type_products'] }}</div>
                            <div class="col-md-1"><a href="{{ url('wpanel/productsdetails/'.$row['id'].'/edit') }}">{{ trans('globals.edit') }}</a></div>
                        </div>
                    </li>
                    @endforeach
                </ul>
