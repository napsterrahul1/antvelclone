                ...
                <div class="panel panel-default">
                    <div class="panel-heading" ng-init="search=''">
                        <h3>
                            ...
                            <a href="{{ url('wpanel/productsdetails/create') }}" class="btn btn-default btn-md pull-right visible-lg-inline">{{ trans('features.new_feature') }}</a>
                            <a href="{{ url('wpanel/productsdetails/create') }}" class="btn btn-default btn-md visible-xs-block">{{ trans('features.new_feature') }}</a>
                        </h3>
                    </div>
                    <ul class="list-group">
