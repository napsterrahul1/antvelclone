...
{{--    {!! Form::label(trans('about.type_of_request')) !!}: <br>--}}
  ...
  <div class="form-group col-md-12">
    ...
    <div class="form-group col-md-12">
        ...
        {!! Form::text('number', null,['required','class'=>'form-control','placeholder'=>'We need your mobile to be in touch']) !!}
    </div>
    </div>
    <div class="form-group col-md-12">
        <div class="col-lg-3">
        {!! Form::label('company/') !!} {!! Form::label('Address') !!}:
            </div>
        <div class="col-lg-9">
        {!! Form::textarea('company', null, ['required','class'=>'form-control','rows'=>'3','placeholder'=>trans('about.company_placeholder')]) !!}
    </div>
    </div>
  <div class="form-group col-md-12">
      <div class="col-lg-3">
  ...
  <div class="form-group col-md-12">
    {!! Form::submit(trans('about.contact_us'),['class'=>'btn btn-primary pull-right','style'=>'width: 67%;margin-right: 12px;']) !!}
  </div>
</fieldset>
</from>