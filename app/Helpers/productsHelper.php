...
class productsHelper
{
     ...
     */
    public static function suggest($type, $limit = 4,$catid =1)
    {
        $data = [];
        switch ($type) {
            case 'purchased':
            ...
            case 'carousel':
                return ProductsController::getTopRated(0, $limit, false ,$catid);
            break;
        ...
        $suggest = ProductsController::getSuggestions($data,$catid); //suggestion array
        return $suggest;
